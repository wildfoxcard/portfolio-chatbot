 ...
 */
export declare class AzureService extends ConnectedService implements IAzureService {
    /**
     * Tenant ID for azure.
     */
    tenantId: string;
     ...
     */
    constructor(source: IAzureService, type: ServiceTypes);
}
//# sourceMappingURL=azureService.d.ts.map